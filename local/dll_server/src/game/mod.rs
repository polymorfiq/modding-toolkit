...
pub static mut ADDR_GNAMES: *const TNameEntryArray<'static> = std::ptr::null();
...
pub fn init() {
    unsafe {
        ...
        let get_names: fn() -> *const TNameEntryArray<'static> = std::mem::transmute(offset_addr(OFFSET_FUNC_GETNAMES));
...
pub fn get_gnames_addr<'a>() -> *const TNameEntryArray<'a> {
...
pub fn get_gnames<'a>() -> TNameEntryArray<'a> {
