...
pub struct FWorldContext<'a> {
    ...
    _padding_a: [u8; 7],
    pub seamless_travel_handler: FSeamlessTravelHandler<'a>,
    ...
    pub packages_to_fully_load: TArray<UnknownType>,
    pub levels_to_load_for_pending_map_change: TArray<FName>,
    pub loaded_levels_for_pending_map_change: TArray<*const ULevel<'a>>,
    pub pending_map_change_failure_description: FString,
    _b_a: u8,
    _padding_d: [u8; 7],
    pub object_referencers: TArray<UnknownType>,
    pub pending_level_streaming_status_updates: TArray<UnknownType>,
    pub game_viewport: *const UnknownType,
    pub owning_game_instance: *const UGameInstance<'a>,
    pub active_net_driver: TArray<UnknownType>,
    ...
    _padding_g: [u8; 4],
    pub external_references: TArray<*const UWorld<'a>>,
    pub this_current_world: *const UWorld<'a>
}
