...
pub struct UClass {
    ...
    pub class_generated_by: *const UObject<*const UnknownType>,
    ...
    pub class_default_object: *const UObject<*const UnknownType>, // 264
...
impl UClass {
    ...
    pub fn default_object<'b>(&self) -> Option<&'b UObject<*const UnknownType>> {
    ...
    pub fn generated_by<'b>(&self) -> Option<&'b UObject<*const UnknownType>> {
